...
#ifndef __TRIMODEL465__
#define __TRIMODEL465__

inline float loadTriModel(char * fileName, int nVertices, glm::vec4 vertex[], glm::vec4 color[], glm::vec3 normal[]) {
...
inline float loadModelBuffer(char modelFile[25], GLuint nVertices,
